...
public class EventHooks {
    ...
    @SafeVarargs
    public static Either<Boolean, List<MapCodec<? extends OperatorInfo>>> allowDataMerge(boolean followingLogout, OperatorEntity entity, Operator operator, @Nullable MapCodec<? extends OperatorInfo>... types) {
