...
public class DataAttachmentRegistry {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<PlayerOpeHandlerNoRepetition.LevelContainer>> OPE_HANDLER =
            REGISTER.register("ope_handler", () -> AttachmentType.builder(() -> new PlayerOpeHandlerNoRepetition.LevelContainer(4,true)).serialize(PlayerOpeHandlerNoRepetition.LevelContainer.CODEC).build());
}
